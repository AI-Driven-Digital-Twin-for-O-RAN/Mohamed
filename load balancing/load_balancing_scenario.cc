...
// Per-UE speed (m/s) — realistic distribution for load balancing scenario
// UE1-8 (Cell 2, overloaded): mostly pedestrians to stay near center
// UE9-20 (neighbor cells): mix of walkers, cyclists, vehicles
