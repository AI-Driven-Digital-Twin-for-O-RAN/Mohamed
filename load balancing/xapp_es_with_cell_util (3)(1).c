 ...
 * ====================================================================== */
#define UE_SPEED_DEFAULT_MPS  215.0   /* avg للـ RandomWaypoint UEs (150-280 m/s) */
...
static const double __attribute__((unused)) g_ue_speed_mps[MAX_REGISTERED_UES] = {
    ...
    /* 1  */ 0.0,     /* UE1  — ConstantPosition (fixed at 900,1300) */
    /* 2  */ 215.0,   /* UE2  — RandomWaypoint 150-280 m/s → avg */
    /* 3  */ 200.0,   /* UE3  — ConstantVelocity northeast 200 m/s */
    /* 4  */ 215.0,   /* UE4  — RandomWaypoint */
    /* 5  */ 215.0,   /* UE5  — RandomWaypoint */
    /* 6  */ 215.0,   /* UE6  — RandomWaypoint */
    /* 7  */ 215.0,   /* UE7  — RandomWaypoint */
    /* 8  */ 0.0,     /* UE8  — ConstantPosition (fixed at 800,1190) */
    /* 9  */ 200.0,   /* UE9  — ConstantVelocity southeast 200 m/s */
    /* 10 */ 200.0,   /* UE10 — ConstantVelocity southwest 200 m/s */
    /* 11 */ 215.0,   /* UE11 — RandomWaypoint */
    /* 12 */ 215.0,   /* UE12 — RandomWaypoint */
    /* 13 */ 215.0,   /* UE13 — RandomWaypoint */
    /* 14 */ 215.0,   /* UE14 — RandomWaypoint */
    /* 15 */ 215.0,   /* UE15 — RandomWaypoint */
    /* 16 */ 215.0,   /* UE16 — RandomWaypoint */
    /* 17 */ 215.0,   /* UE17 — RandomWaypoint */
    /* 18 */ 215.0,   /* UE18 — RandomWaypoint */
    /* 19 */ 215.0,   /* UE19 — RandomWaypoint */
    /* 20 */ 215.0,   /* UE20 — RandomWaypoint */
    /* 21-63 */ 215.0, 215.0, 215.0, 215.0, 215.0, 215.0, 215.0, 215.0,
 ...
 * ====================================================================== */
#define HOM_MIN_DB   0.0    // paper Table-1 HOMmin  = 0 dB
...
if (serving_ue->prb_used > 0) {
    ...
    printf("  │  ΔHOM (clamped [0,20]) = " CLR_BYELLOW "%+.3f dB\n" CLR_RESET, delta_HOM);
