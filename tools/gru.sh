...
#  After any reboot, just run:  bash gru.sh   (from the repo root)
#
...
# PROJECT_ROOT = repo root. This script lives at tools/gru.sh, so we go one dir up.
...
XAPP_GRU="${PROJECT_ROOT}/platform/flexric/build/examples/xApp/c/handover_gru/xapp_handover_gru"
GRU_PY="${PROJECT_ROOT}/xapps/gru-handover/python-service/gru_xapp.py"
