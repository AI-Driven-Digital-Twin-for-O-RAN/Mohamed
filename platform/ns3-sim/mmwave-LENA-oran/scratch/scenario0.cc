...
main(int argc, char *argv[]) {
    ...
    ueMob0->SetVelocity(Vector(-8, 5, 0));  // Moving northwest at ~9.4 m/s
    ...
    ueMob1->SetVelocity(Vector(-7, 6, 0));  // Moving northwest
    ...
    ueMob2->SetVelocity(Vector(-4, -8, 0));  // Moving southwest at ~8.9 m/s
    ...
    ueMob3->SetVelocity(Vector(-5, -7, 0));  // Moving southwest
    ...
    ueMob4->SetVelocity(Vector(9, 0, 0));  // Moving east at 9 m/s
    ...
    ueMob5->SetVelocity(Vector(8, 2, 0));  // Moving east-northeast
