...
// Expose current callback E2 node to xApps (set by dispatcher thread)
extern global_e2_node_id_t g_current_cb_e2_node;
extern bool g_current_cb_e2_node_valid;
