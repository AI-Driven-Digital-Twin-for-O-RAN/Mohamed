...
// Current E2 node context for the callback being executed in worker thread
global_e2_node_id_t g_current_cb_e2_node;
bool g_current_cb_e2_node_valid = false;
...
void* worker_thread(void* arg)
{
  ...
  while(true){
    ...
    // Set current E2 node context for this callback
    g_current_cb_e2_node = msg->e2_node;
    g_current_cb_e2_node_valid = true;

    msg->sm_cb(&msg->rd);

    g_current_cb_e2_node_valid = false;
